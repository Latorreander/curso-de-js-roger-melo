...
}else{message = 'Para você a entrada é R$ 30,00.'}
...
for(let i = 0; i < crazyArray.length; i++){
  ...
  const isAItemABoolean = typeofItem === 'boolean'
  const isAItemANumber = typeofItem === 'number'


  if(isAItemABoolean) {
    booleansQuantity ++
  }else if(isAItemANumber) {
    numbersQuantity ++
  } else {stringsQuantity ++}
} 

console.log(`O crazyArray tem ${booleansQuantity} booleans, ${numbersQuantity} números e ${stringsQuantity} strings.`)
