...
*/
const my3FavoriteTVShows = ['Prision Break', 'Braking Bad', 'The Walking Dead']
...
/*
  ...
  caracteres? BOOLEAN."
*/
const numberCheked = 39

// console.log(`A string que a "typeSentence" armazena tem mais de ${numberCheked}  
// caracteres? ${String(typeSentence.length > numberCheked).replace('t', 'T')}`)
...
/*
  ...
  //porque null é zero, zero + 1 resulta em 1, qualquer número que não seje 0 tem true como resultado boleano
*/
